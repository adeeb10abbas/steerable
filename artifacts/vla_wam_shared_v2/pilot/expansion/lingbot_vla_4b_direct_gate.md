# LingBot-VLA 4B standardized direct-command pilot

Compiled at `2026-08-03T19:05:38.281919+00:00` from 6 executed episodes in 3 exact left/right scene pairs.
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| pair00 | success | failure | -0.124 m | +0.004 m | +0.129 m | aligned |
| pair01 | failure | failure | +0.041 m | -0.135 m | -0.176 m | anti directed |
| pair02 | failure | failure | -0.106 m | -0.086 m | +0.020 m | aligned |
