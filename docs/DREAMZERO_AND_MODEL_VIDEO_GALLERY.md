# Matched VLA/WAM video evidence

This is the portable index for the embedded [HTML video gallery](VLA_WAM_STEERABILITY_VIDEO_GALLERY.html). DROID and RoboTwin are listed separately and their success rates are never pooled.
...
[Open same-seed imagined-future control](../artifacts/vla_wam_shared_v2/media/dreamzero_droid/imagination/paired/dreamzero_seed8300_left_right_imagined_futures.mp4)
...
[Open same-seed imagined-future control](../artifacts/vla_wam_shared_v2/media/dreamzero_droid/imagination/paired/dreamzero_seed8301_left_right_imagined_futures.mp4)
...
[Open same-seed imagined-future control](../artifacts/vla_wam_shared_v2/media/dreamzero_droid/imagination/paired/dreamzero_seed8302_left_right_imagined_futures.mp4)
...
- Future interface: Decoded video futures plus actions; 17 decoded futures retained for this pair; no separate matched imagination MP4 is selected in this gallery
...
- Future interface: Decoded coarse future video plus actions; publication clip shows simulator execution; no separate matched future MP4 is selected
...
[Open same-seed actual rollout control](../artifacts/vla_wam_shared_v2/media/dreamzero_droid/dreamzero_droid_seed8300_paired.mp4)
...
[Open same-seed actual rollout control](../artifacts/vla_wam_shared_v2/media/dreamzero_droid/dreamzero_droid_seed8301_paired.mp4)
...
[Open same-seed actual rollout control](../artifacts/vla_wam_shared_v2/media/dreamzero_droid/dreamzero_droid_seed8302_paired.mp4)
...
### π0-FAST DROID — historical frozen-stack reference — seed 8300 matched pair
...
- Future interface: Actions only; no decoded visual future
- Evidence status: Historical frozen-stack behavioral pair; LEFT failed and RIGHT succeeded; not a substitute for current-stack or new-protocol inference
