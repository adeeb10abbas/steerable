"""Frozen neutral-scene LEFT task for the v2 DROID arena."""
...
class RubiksCubeLeftOfBowlMatchedTask(Task):
    ...
    # The released upstream scene starts the cube inside the RIGHT cone.  The
    # frozen v2 matched arena moves only the cube to this preregistered neutral
    # longitudinal pose, where neither LEFT nor RIGHT is true at reset.
