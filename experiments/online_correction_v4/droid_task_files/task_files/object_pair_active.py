"""V4 active C7 sponge/tray task resolved from the episode binding."""
...
from experiments.online_correction_v4.droid_task_files import object_pair_shared as shared


@dataclass
class V4ObjectPairActiveTask(Task):
    contact_object_list = list(shared.OBJECT_PAIR_CONTACT_OBJECTS)
