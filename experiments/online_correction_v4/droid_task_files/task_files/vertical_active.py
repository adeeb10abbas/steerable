"""V4 active C5 vertical task resolved from the episode binding."""
...
from experiments.online_correction_v4.droid_task_files import vertical_shared as shared


@dataclass
class V4VerticalActiveTask(Task):
    contact_object_list = list(shared.VERTICAL_CONTACT_OBJECTS)
