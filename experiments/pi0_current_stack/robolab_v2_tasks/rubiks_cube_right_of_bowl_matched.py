"""Neutral-reset RIGHT task with the frozen V2-A008 wording families."""
...
class RubiksCubeRightOfBowlMatchedTask(Task):
    ...
    instruction = {
        "short_command": "Put the cube right of the bowl.",
        "goal_as_outcome": "The Rubik's cube should end up to the right of the bowl.",
        "desired_plus_negated_opposite": (
            "Put the Rubik's cube to the right of the bowl, not to the left of the bowl."
        ),
    }
