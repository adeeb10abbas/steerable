#!/usr/bin/env python3
"""Compile one released V3-B005 Nano cell into retained raw episode JSONL.
...
def build_behavioral_record(
    *,
    ...
    diagnostics = {
        "schema_version": "vla-wam-shared-v3b005-nano-episode-diagnostics-v1",
    ...
    normalized["nano_v3b005_diagnostics"] = diagnostics
    return normalized
...
def compile_cell(
    *,
    ...
    verify_behavioral_release_gate(release_gate, release=release, runtime=runtime)
