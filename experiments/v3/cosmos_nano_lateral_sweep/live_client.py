"""Exact Cosmos3 Nano client overlay for one released V3-B005 cell."""
...
class V3BNanoLiveClient(V2Cosmos3Client):
    ...
    def _write_trace(self) -> None:
        ...
        metadata.update(
            ...
            level_index=self.cell.level_index,
            reference_object_initial_lateral_position_y_m=self.cell.level_y_m,
