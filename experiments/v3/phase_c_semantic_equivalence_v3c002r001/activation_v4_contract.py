...
def require_a004_gate(*, registration_path: Path, queue_path: Path, release_gate_path: Path):
    ...
    if kind == "a003":
        ...
        require(activation["sha256"] == repair["sha256"] == "2323b8b4094598ae5584cacfb43abcf2f9607a241428106972c3d0c736303579", "A003 activation/repair registration changed")
        require(replacement["sha256"] == "a71429f8c8313e1b1981e842b914a72ef25219410c952558fc4bd16d56718cdf", "A003 replacement registration changed")
