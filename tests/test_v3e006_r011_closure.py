...
from tools.validate_v3e006_r011_closure import validate_compact_contract


ROOT = Path(__file__).resolve().parents[1]
RESULTS = ROOT / "artifacts/vla_wam_shared_v3/phase_e/canonical_stage_localization_v3e006_r011/results/results.json"


def test_r011_closure_contract_and_mutations() -> None:
    ...
    for key, replacement in (
        ...
        ("intended_r011_construction_scientifically_exhausted", True),
        ("behavioral_activation_released", True),
        ("final_state_construction_blocker", False),
    ):
        bad = deepcopy(value)
        bad[key] = replacement
