...
const sourceRows = [
  [
    ...
    "artifacts/vla_wam_shared_v2/results/direct_command_cross_model_comparison.json",
    "https://github.com/adeeb10abbas/steerable/blob/codex/wam-language-steerability/artifacts/vla_wam_shared_v2/results/direct_command_cross_model_comparison.json",
  ],
  [
    "Endpoint alignment",
    ...
    "https://github.com/adeeb10abbas/steerable/blob/codex/wam-language-steerability/docs/VLA_WAM_STEERABILITY_V2_PROTOCOL.md",
  ],
  [
    "Action distinctness",
  ...
  [
    ...
    "https://github.com/adeeb10abbas/steerable/blob/codex/wam-language-steerability/artifacts/vla_wam_shared_v2/results/direct_command_cross_model_comparison.md",
  ],
  [
    "Arena separation",
    ...
    "https://github.com/adeeb10abbas/steerable/blob/codex/wam-language-steerability/docs/VLA_WAM_RESEARCH_BLOG.md",
  ],
  [
    "Video roles",
    ...
    "https://github.com/adeeb10abbas/steerable/blob/codex/wam-language-steerability/artifacts/vla_wam_shared_v2/media/README.md",
  ],
  [
    ...
    "https://github.com/adeeb10abbas/steerable/blob/codex/wam-language-steerability/artifacts/vla_wam_shared_v2/results/direct_command_cross_model_comparison_manifest.json",
  ],
  [
    "Evidence cutoff commit",
    comparison.evidence_cutoff_git_commit,
    "Git branch codex/wam-language-steerability",
    "https://github.com/adeeb10abbas/steerable/tree/codex/wam-language-steerability",
  ],
];
