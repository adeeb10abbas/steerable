...
def main():
    ...
    value={'schema_version':CONTINUATION_SCHEMA,'status':'passed_outcome_blind_a004_continuation_release','passed':True,'a003_release':file_binding(a.a003_release),'original_release':file_binding(Path('artifacts/vla_wam_shared_v3/phase_c/semantic_equivalence_v3c002r001/activation_v3/release_gate.released.json')),'repair_registration':original['repair_registration'],'queue':file_binding(a.queue),'assignment_manifest':file_binding(a.assignment),'a004_registration':file_binding(a.registration),'retry_markers':completed,'all_completed_markers_by_lane':marker_roots,'remaining_seed_blocks_by_lane':remaining,'lane_manifests':lanes,'completed_blocks_never_rerun':True,'no_cross_lane_failover':True,'outcome_fields_read':False,'science_unchanged':True}
