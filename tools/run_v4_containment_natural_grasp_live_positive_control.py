#!/usr/bin/env python3
"""Live Isaac positive control for containment NaturalGraspDetector."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        infra = {
            "schema_version": "v4-containment-natural-grasp-live-positive-control-infra-v1",
            "attempt_id": args.attempt_id,
            "fixture_id": FIXTURE_ID,
