#!/usr/bin/env python3
"""Live Isaac positive control for reference_binding NaturalGraspDetector."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        infra = {
            "schema_version": "v4-reference-binding-natural-grasp-live-positive-control-infra-v1",
            "attempt_id": args.attempt_id,
            "fixture_id": FIXTURE_ID,
