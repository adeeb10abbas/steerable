#!/usr/bin/env python3
"""Validate the compact V3-E006-R008 closure and optionally its raw bindings."""
...
CLOSURE = (
    ROOT
    / "artifacts/vla_wam_shared_v3/phase_e/canonical_stage_localization_v3e006_r008/results"
)
...
def main() -> None:
    ...
    require(
        counts.get("physics_check_pass_counts", {}).get("normal_gripper_contact") == 0
