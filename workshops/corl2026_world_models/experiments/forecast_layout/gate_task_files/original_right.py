"""Unreleased-candidate original-layout RIGHT calibration task."""
...
WMFGateOriginalRightTask = build_candidate_gate_task_class(
    ...
    layout_arm="original",
    command="right",
    class_name="WMFGateOriginalRightTask",
)
