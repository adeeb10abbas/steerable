"""Unreleased-candidate reflected-layout LEFT calibration task."""
...
WMFGateReflectedLeftTask = build_candidate_gate_task_class(
    ...
    command="left",
    class_name="WMFGateReflectedLeftTask",
)
